    ...
    <div className=" w-full relative ">
      ...
      <div className="container mx-auto relative md:~h-[50rem]/[38rem] h-[40rem] ">
        <div className="hidden xl:block absolute top-[3.125rem] left-[1.25rem]">
          <FadeInAnimation delay={0.2} x1={-20} x2={0} duration={1}>
        ...
        <div className="flex flex-col xl:flex-row ~gap-[3.25rem]/[1rem] items-center  ~pt-[2.5rem]/[5.2rem] ~pl-[1rem]/[7.8rem] ~pr-[1rem]/[5rem] relative">
          ...
          <WordStaggerAnimation
            text="AIP is a peer network that <color>channels the flow</color> to accelerate strategic giving in India - a movement <color>by and for philanthropists</color>"
          ...
          />
          <FadeInAnimation delay={0.1} y1={-20} y2={0} duration={1} className="block lg:hidden absolute ~/md:~bottom-0/[-12rem]  inset-x-0">
            <Image
              src={SmHeroBg}
              alt="sm-hero-bg"
          ...
          <FadeInAnimation duration={1} delay={0.2} x1={-20} x2={0}>
