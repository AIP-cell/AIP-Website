...
const Story = () => {
  return (
    <div className="container tw-mx-auto tw-overflow-hidden tw-relative tw-h-screen tw-flex tw-flex-col tw-justify-center tw-items-center">
      ...
      {/* </div> */}
      <h2 className="tw-text-h2Heading2 tw-text-gray80 tw-flex tw-justify-center">
      ...
      <div className=" tw-pt-[3rem]  tw-flex tw-flex-col tw-justify-center tw-items-center tw-gap-[1rem]">
        <div className="tw-flex tw-flex-col tw-text-midGray tw-font-inter tw-items-center tw-justify-center tw-text-h9BodyCopy4 tw-leading-[22.4px]">
          <p> When a river flows,</p>
          <p>it gives as much as it can</p>
          <p>To everyone on its way</p>
        </div>

        <div className="tw-flex tw-flex-col tw-items-center tw-text-midGray tw-font-inter tw-justify-center tw-text-h9BodyCopy4 tw-leading-[22.4px]">
