    ...
    <div className="tw-flex tw-overflow-hidden container tw-mx-auto  tw-gap-[6rem] tw-pt-[12.75rem] tw-pl-[7.8rem] tw-pr-[6.56rem]">
      <div className=" ">
        <div className="tw-bg-purpleToPink tw-bg-clip-text ">
          <h3 className="tw-text-transparent tw-text-h9Copy4 tw-font-inter tw-font-bold tw-leading-[22.4px]">
            UPCOMING EVENT
          </h3>
        </div>
        ...
        <span className="tw-text-h2 tw-text-textPurple tw-font-playFairItalic tw-leading-[52.8px]">
          Exemplars Report
        </span>
        ...
        <div className="tw-pt-[1.25rem]">
          <BgButton
            text="Event Details"
            className="tw-px-[2rem] tw-py-[0.75rem] tw-text-h9Copy4 tw-leading-[1.4rem]"
          />
        </div>
      </div>
