...
const MakeDifference = () => {
  return (
    <div className="container tw-mx-auto tw-relative ~tw-pt-[4.8rem]/[13rem] tw-flex tw-flex-col tw-items-center tw-justify-center">
      <Image src={LeftHomePagePeachCurve} alt="" className="tw-left-0 tw-absolute lg:tw-bottom-0 tw-top-[4rem] lg:tw-top-auto ~tw-w-[6.956rem]/[13.125rem] ~tw-h-[19.875rem]/[37.5rem]"/>
