        ...
        <div className="relative container mx-auto ~px-[1.25rem]/[7.8rem]">
          <div className=" pt-[5rem] grid md:grid-cols-2">
            ...
            <div className=" ">
              ...
              />
              <WordStaggerAnimation
                className="font-inter text-h9Copy5/h9Copy4 ~leading-[1.225rem]/[1.4rem] pt-[1.25rem]  text-midGray md:text-gray60"
                text=" Please fill the form below to connect with a specific office
