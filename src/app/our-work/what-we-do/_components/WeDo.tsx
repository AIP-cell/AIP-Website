  ...
  return (
    <div className="tw-w-full tw-relative">
      ...
      <div className="~tw-pt-[2.725rem]/[6.63rem] tw-pb-[7.5rem] tw-relative container tw-mx-auto">
        ...
        <p className="tw-leading-[1.4rem] tw-text-gray80 tw-text-center tw-pt-[1.25rem]">
          AIP has four core offerings for propelling and guiding <br />
          philanthropists in their giving journey
        </p>
        <div className="~tw-px-5/[7.8rem] ~tw-pt-[2.5rem]/[5rem] tw-flex tw-flex-col tw-justify-center ~tw-gap-[3.5rem]/0">
