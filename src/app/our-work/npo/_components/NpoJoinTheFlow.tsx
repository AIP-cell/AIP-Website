    ...
    <div className="w-full relative ">
      ...
      <div className="relative container mx-auto ~pb-[5rem]/[10rem]">
        <div className="relative flex flex-col items-center justify-center ~pt-0/[8.43rem]">
          ...
          />
          <TextStaggerAnimation className="text-midGray text-center ~px-5/[20.94rem] ~text-h9Copy5/h9Copy4 ~leading-[1.225rem]/[1.4rem] ~pt-[1.5rem]/[1.25rem]" text=" We invite you to showcase your work and get the opportunity to join
            our NPO repository."/>
          {/* <p className="text-midGray text-center ~px-5/[20.94rem] ~text-h9Copy5/h9Copy4 ~leading-[1.225rem]/[1.4rem] ~pt-[1.5rem]/[1.25rem]">
            We invite you to showcase your work and get the opportunity to join
            our NPO repository.
          </p> */}
          <div className="flex flex-col justify-center md:flex-row ~gap-[0.75rem]/[1.5rem] items-center ~pt-[1.5rem]/[2.5rem]">
            ...
            <ButtonAnimation className=" text-white hover:text-darkPurple bg-darkPurple hover:bg-white transition-all duration-500 rounded-full  py-[0.75rem] px-[1.75rem]">
              <Link
                href="/contact"
