  ...
  return (
    <div className="tw-w-full tw-relative">
      ...
      <Image
        ...
        alt=""
        className="tw-hidden lg:tw-block tw-absolute tw-bottom-[-3.9rem] tw-right-0 tw-w-[15.313rem] tw-h-[15.125rem]"
      />
      <div className="tw-relative container tw-mx-auto">
        <div className="tw-relative tw-flex tw-flex-col tw-items-center tw-justify-center ~tw-pt-0/[8.43rem]">
          ...
          <p className="tw-text-midGray tw-text-center ~tw-px-5/[20.94rem] ~tw-text-h9Copy5/h9Copy4 ~tw-leading-[1.225rem]/[1.4rem] ~tw-pt-[1.5rem]/[1.25rem]">
          ...
          <div className="tw-flex tw-flex-col tw-justify-center md:tw-flex-row ~tw-gap-[0.75rem]/[1.5rem] tw-items-center ~tw-pt-[1.5rem]/[2.5rem]">
            <BgButton
              text="Register With Us"
              className="tw-text-h9Copy5 tw-leading-[1.225rem] tw-py-[0.75rem] tw-px-[1.75rem]"
            />
            <OutlineButton
              text="A Member Already? Login!"
              className="tw-text-h9Copy5 tw-leading-[1.225rem] tw-py-[0.75rem] tw-px-[1.75rem] tw-font-medium "
              buttonClassName="tw-rounded-full tw-h-fit"
            />
