    ...
    <div className="tw-pt-[3rem] tw-pb-[7rem] container tw-mx-auto">
      ...
      <div className="~tw-pt-[4.83rem]/[7.875rem] tw-flex md:tw-block tw-flex-col tw-items-center ~tw-px-[1.25rem]/[7.8rem] tw-relative">
        <Image
          src={Bg1}
          alt=""
          className="tw-hidden md:tw-block tw-absolute tw-top-[7.875rem] tw-right-0"
        />
        <Image
          src={OvalPeach}
          alt=""
          className="tw-hidden md:tw-block tw-absolute tw-top-[28.56rem] tw-right-[14.125rem] tw-size-[12rem]"
        />
        <Image src={Bg2} alt="" className="tw-hidden md:tw-block tw-absolute tw-bottom-0 tw-left-0" />
        <Image
          src={OvalPeach}
          alt=""
          className="tw-hidden md:tw-block tw-absolute tw-bottom-[15.75rem] tw-left-[17rem] tw-size-[12rem]"
        />
