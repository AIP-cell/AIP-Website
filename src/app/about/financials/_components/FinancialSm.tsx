...
const FinancialSm = () => {
  ...
  return (
    <div className="md:tw-hidden tw-pt-[2.5rem]">
      ...
      />
      <div className="tw-flex tw-flex-col tw-gap-[3rem] tw-px-5 tw-pt-[2.5rem] ~tw-pb-[5rem]/[7.5rem]">
        ...
        <div>
          {datas.map((item, i) => (
            ...
            >
              <div className="tw-leading-[1.4rem] tw-text-gray80 ~tw-text-h9Copy5/h9Copy4 tw-w-full">
                {item.title}
              </div>
