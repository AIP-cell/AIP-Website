  ...
  return (
    <div className="w-full relative ">
      ...
      {/* <Image
        ...
        alt=""
        className=" absolute bottom-[-3.9rem] right-0 w-[15.313rem] h-[15.125rem]"
      /> */}
      <div className="relative container mx-auto">
        ...
        />
        <TextStaggerAnimation className="text-midGray text-center ~px-[2.813rem]/[20.94rem] ~pt-[1rem]/[1.25rem] ~leading-[1.225rem]/[1.4rem] ~text-h9Copy5/h9Copy4" text="We invite you to join our Core Founders, Founders, and our growing
