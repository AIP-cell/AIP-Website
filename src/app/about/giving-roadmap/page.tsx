    ...
    <div className="tw-pt-[5rem]">
      <div className="tw-relative bg-container tw-mx-auto">
        <Image
          src={Bg}
          alt=""
          className="tw-hidden md:tw-block tw-absolute tw-top-[9rem] tw-object-cover tw-w-full"
        />
        <Image
          src={SmBg}
          alt=""
          className="tw-block md:tw-hidden tw-absolute tw-top-[9rem] tw-object-cover tw-w-full"
        />
        <div className="container tw-mx-auto tw-relative">
          ...
          <div className="tw-relative">
            ...
            <Image
              ...
              alt=""
              className="tw-hidden lg:tw-block tw-absolute tw-z-[-1] tw-top-[8.5rem] tw-right-0"
            />
            <Image
              src={PeachSmallCircleBg}
              alt=""
              className="tw-hidden lg:tw-block tw-absolute tw-z-[-1] tw-top-[24.8rem] tw-right-[5.37rem]"
            />
