...
//         console.log("cardWidth-left::", textWidth, OvalWidth );
//         textRef.current.scrollBy({ left: -textWidth });
//         OvalRef.current.scrollBy({ left: -OvalWidth });
//       }
//     }
//   };
//   const next = () => {
...
//         const textWidth = textSlide.offsetWidth;
//         const OvalWidth = OvalSlide.offsetWidth;
//         console.log("cardWidth-right::", textWidth, OvalWidth );
//         textRef.current.scrollBy({ left: textWidth, });
//         OvalRef.current.scrollBy({ left: OvalWidth });
//       }
//     }
...
//               <div
//                 ref={OvalRef}
//                 className="~px-[10rem]/[30.5rem] flex  snap-x snap-mandatory  overflow-x-scroll no-scrollbar gap-[5rem] w-full"
//               >
