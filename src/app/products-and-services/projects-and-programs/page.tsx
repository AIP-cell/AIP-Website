  ...
  return (
    <div className=" tw-relative tw-overflow-hidden">
      <Image
        src={projectBg}
        alt="bg"
        className="tw-left-40 tw-absolute tw-top-[-6rem] "
      />
      <div className="container tw-mx-auto tw-relative tw-px-[7.8rem] tw-pt-[5rem]">
        ...
        <p className="tw-leading-[2.6rem] tw-font-playFair tw-text-h4 tw-text-gray80 tw-pt-5 tw-pb-[5rem] tw-tracking-[-0.02rem]">
          Through our projects and programs, we inspire and influence each other
          by sharing their motivations, knowledge, ideas and experiences. All to
          enable shared learning and collaboration with insights across sectors
