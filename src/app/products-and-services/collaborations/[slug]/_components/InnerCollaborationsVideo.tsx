...
const InnerCollaborationsVideo = () => {
  return (
    <div className="tw-pt-[7.5rem] container tw-relative tw-flex tw-justify-center tw-mx-auto">
        <Image
          src={rightBottomCurve}
          alt="video-bg"
          className=" tw-absolute tw-left-0 tw-bottom-[-18.625rem]"
        />
      <div className="tw-w-[64.375rem] tw-relative tw-flex tw-justify-center tw-items-center tw-h-[35.313rem] tw-overflow-hidden tw-rounded-lg">
        <Image
          src={BgVideo}
          alt="video-bg"
