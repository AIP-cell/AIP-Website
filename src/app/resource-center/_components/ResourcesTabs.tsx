...
const ResourcesTabs = () => {
  return (
    <TabGroup className="tw-flex tw-flex-col tw-justify-center ">
      <TabList className="tw-flex tw-bg-[#F0F0F2] tw-rounded-full tw-w-fit tw-p-[.25rem] tw-ml-[8rem]">
        <Tab className="tw-px-[2.5rem] tw-py-[.75rem] data-[selected]:tw-bg-darkPurple data-[selected]:tw-text-white data-[selected]:tw-rounded-full tw-text-h9Copy5 tw-leading-[1.22rem] tw-font-inter data-[selected]:tw-outline-none">
          Reports
        </Tab>
        <Tab className="tw-px-[2.5rem] tw-py-[.75rem] data-[selected]:tw-bg-darkPurple data-[selected]:tw-text-white data-[selected]:tw-rounded-full tw-text-h9Copy5 tw-leading-[1.22rem] tw-font-inter data-[selected]:tw-outline-none">
          Knowledge Resources
      ...
      <TabPanels className="tw-px-[7.8rem]">
        ...
        <TabPanel>
          <div className="tw-pt-[3.25rem] tw-pb-[7.5rem] tw-grid md:tw-grid-cols-3 tw-gap-[4.5rem]">
            {datas.map((item, i) => (
              <ResourceCard
                key={i}
                src={item.src}
