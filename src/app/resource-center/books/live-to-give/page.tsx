...
import second from "@public/images/love-give.png";
          ...
          <div className="flex lg:flex-row flex-col-reverse ~gap-[1rem]/[1.25rem]  ">
            <div className="pt-[1rem] shrink-0 lg:w-[60%]">
              ...
              <div className=" ~text-h9Copy5/h9Copy4 lg:max-w-[50ch] ~pt-[0.75rem]/[1rem] ~leading-[1.225rem]/[1.4rem] text-midGray/70 ">
                ...
                challenges, and impact of individuals who chose to dedicate
                their wealth and energy toward creating social change. Blending
                narrative storytelling with real-world insights, the book
                captures both the personal journeys of givers and the broader
            ...
            <div className="lg:w-[40%]">
              <div className="relative w-full ~h-[20.8926620483rem]/[39.0306129456rem]">
                {" "}
                <Image fill src={second} alt="" className="object-contain" />
              </div>
            </div>
          </div>
        </div>
