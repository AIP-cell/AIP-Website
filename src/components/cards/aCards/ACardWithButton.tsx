    ...
    <div className="tw-w-[18.43rem] tw-relative ">
      ...
      <div className="tw-flex tw-flex-col tw-gap-[0.75rem]">
          <div className="tw-flex tw-items-center tw-gap-[0.75rem]">
            <h3 className="tw-text-h4Heading4 tw-leading-[2.6rem] tw-text-gray80 tw-font-playFair">Ashish Dhawan</h3>
          ...
          <h4 className="tw-text-h5Heading5 tw-font-playFair tw-text-gray50 tw-font-medium tw-italic">
          The Convergence Foundation    
          </h4>
          <p className="tw-text-h9BodyCopy4 tw-leading-[1.4rem] tw-font-inter ">
