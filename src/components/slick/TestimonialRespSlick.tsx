...
const TestimonialRespSlick = ({ slickArray }: Props) => {
  ...
  return (
    <div className="tw-block md:tw-hidden ~tw-pt-[2.5rem]/[5rem] container tw-mx-auto">
      <div className="tw-relative  tw-flex tw-justify-center tw-items-center">
        <div className="">
          <div className="tw-flex tw-overflow-hidden tw-justify-center tw-gap-[4.563rem]">
        ...
        <div className="tw-flex tw-gap-[1.25rem] tw-absolute tw-bottom-[-8rem] tw-justify-center tw-z-20">
          <ButtonAnimation
            onClick={previous}
