...
const CustomFilter = ({
  ...
  return (
    ...
    //   >
    //     <div
    //       className={`tw-flex tw-gap-[.79rem] tw-text-gray80 tw-text-h9Copy5 ~tw-pl-[0.75rem]/[1.75rem] tw-py-[0.75rem] tw-items-center tw-w-full tw-justify-between ${selectedClassName}`}
    //     >
    //       <p className="   leading-[1.225rem] tw-capitalize">{type}</p>
    //       <DownTagSvg className="tw-size-[1.25rem]" />
