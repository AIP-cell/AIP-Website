...
export const addPhilanthropistNetworkPeople = async (req, res, next) => {
	try {
...
export const updatePhilanthropistPeople = async (req, res, next) => {
	try {
		...
		const people = await PhilanthropistNetworkModel.findOne({ 'people._id': Id, deletedAt: null });
...
export const getPeopleById = async (req, res) => {
	try {
		...
		const people = await PhilanthropistNetworkModel.findOne(
			{
...
export const deletePeople = async (req, res) => {
	try {
		...
		const result = await PhilanthropistNetworkModel.updateOne({ 'people._id': Id }, { $pull: { people: { _id: Id } } });
