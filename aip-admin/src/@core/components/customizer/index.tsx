        ...
        >
          <div className={styles.customizerBody}>
            <div className='flex flex-col gap-6'>
              ...
              <div className='flex flex-col gap-2'>
                ...
                <div className='flex items-center justify-between'>
                  ...
                  <div className='flex flex-col items-start gap-0.5'>
                    <div
                      className={classnames(styles.itemWrapper, styles.modeWrapper, {
                        [styles.active]: (settings.mode ?? 'system') === 'system'
                      })}
              ...
              ((settings.mode ?? 'system')  === 'system' && isSystemDark) ||
            ...
            <div className='flex flex-col gap-6'>
              ...
              <div className='flex flex-col gap-2'>
                ...
                <div className='flex items-center justify-between'>
                  ...
                  <div className='flex flex-col items-start gap-0.5'>
                    <div
                      className={classnames(styles.itemWrapper, {    [styles.active]: (settings.layout ?? 'collapsed') === 'collapsed' })}
