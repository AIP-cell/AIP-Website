...
const PeopleTable = () => {
  ...
  const deleteCategoryData = async (id: any) => {
    ...
    try {
      const response = await PhilanthropistPeopleApi.delete(
        id,
        reqAuthHeader()
      );
        ...
        >
          ...
          <Tooltip title="Edit">
            <IconButton
              size="small"
              component={Link}
              href={`/admin/philanthropist-network/people/edit/` + row._id}
            >
  ...
  return (
    <>
      <Breadcrumbs aria-label="breadcrumb" sx={{ mb: 4 }}>
        <Link href={`/admin/philanthropost-network/people`}>
      ...
      <Card>
        <CardHeader
          title="Philanthropost Network People"
          action={
            <div>
              <Button
                size="medium"
                variant="contained"
                component={Link}
                href={`/admin/philanthropist-network/people/add`}
              >
                Add People
              </Button>
              &nbsp;
