...
import CustomizedSingleImageUploader from "./CustomizedSingleImageUploader";
...
export const PartnershipFormRepeater = ({
  control,
  controlName,
  errors,
  image,
      ...
      <Grid container spacing={6}>
        ...
        {fields.map((field, index: any) => (
          <Fragment key={"field" + index}>
            ...
            <Grid item xs={12} md={12}>
              <label htmlFor="name">Image (155px x 65px)</label>
