...
const FinancialReportTable = () => {
  ...
  const deleteCategoryData = async (id: any) => {
    ...
    try {
      const response = await FinancialReportApi.delete(id, reqAuthHeader());
  ...
  const handleStatusChange = async (id: any) => {
    try {
      const response = await FinancialReportApi.status(id, reqAuthHeader());
      toast.success(response?.data?.message);
      fetchTableData("asc", query);
    } catch (err) {
        ...
        >
          ...
          <Tooltip title="Edit">
            <IconButton
              size="small"
              component={Link}
              href={`/admin/financial-report/report/edit/` + row._id}
            >
          ...
          action={
            <div>
              <Button
                ...
                variant="contained"
                component={Link}
                href={`/admin/financial-report/report/add`}
              >
                Add Report
              </Button>
              &nbsp;
