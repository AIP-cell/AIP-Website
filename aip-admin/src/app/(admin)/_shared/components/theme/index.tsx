...
const ThemeProvider = (props: Props) => {
  ...
  if (isServer) {
    ...
    if ((settings.mode ?? 'system') === 'system') {
      currentMode = isDark ? 'dark' : 'light'; // Handle system mode based on isDark
    } else {
      currentMode = settings.mode as SystemMode; // Ensure settings.mode is a valid SystemMode
    }
  }
