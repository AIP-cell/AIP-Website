...
const NpoCasestudiesTable = () => {
  ...
  const deleteCategoryData = async (id: any) => {
    ...
    try {
      const response = await NpoCaseStudiesApi.delete(id, reqAuthHeader());
        ...
        >
          ...
          <Tooltip title="Edit">
            <IconButton
              size="small"
              component={Link}
              href={`/admin/npo/casestudies/edit/` + row._id}
            >
          ...
          action={
            <div>
              <Button
                ...
                variant="contained"
                component={Link}
                href={`/admin/npo/casestudies/add`}
              >
                Add Case studies
              </Button>
              &nbsp;
...
export default NpoCasestudiesTable;
