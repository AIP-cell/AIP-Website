...
import AipImpactTestimonialsApi from "@/axios/AipImpactTestimonialsApi";
...
const AipImpactPeopleTable = () => {
  ...
  const deleteCategoryData = async (id: any) => {
    ...
    try {
      const response = await AipImpactTestimonialsApi.delete(
        id,
        reqAuthHeader()
      );
      ...
      if (response.data.success) {
        ...
        router.push("/admin/aip-impact/testimonial");
        fetchTableData("asc", query);
      } else {
        ...
        >
          ...
          <Tooltip title="Edit">
            <IconButton
              size="small"
              component={Link}
              href={`/admin/aip-impact/testimonial/edit/` + row._id}
            >
  ...
  return (
    <>
      <Breadcrumbs aria-label="breadcrumb" sx={{ mb: 4 }}>
        ...
        <Typography>Philanthropist speak</Typography>
      </Breadcrumbs>
      <Card>
        <CardHeader
          title="AIP Impact Philanthropist speak"
          action={
            <div>
              <Button
                size="medium"
                variant="contained"
                component={Link}
                href={`/admin/aip-impact/testimonial/add`}
              >
                Add Philanthropist speak
              </Button>
              &nbsp;
            </div>
          }
