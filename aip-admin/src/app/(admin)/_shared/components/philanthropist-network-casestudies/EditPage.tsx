...
export const EditPhilanthropistCasestudiesPage = (values: any) => {
  const {
    register,
    control,
    reset,
    ...
    defaultValues: {
      ...
      organisationName: values.values.organisationName,
  ...
  const onSubmit = async (values: TyearSchema) => {
    try {
      ...
      const response = await PhilanthropistCaseStudiesApi.updateCasestudies(
        id,
        values,
        reqAuthHeader()
      );
...
export default EditPhilanthropistCasestudiesPage;
