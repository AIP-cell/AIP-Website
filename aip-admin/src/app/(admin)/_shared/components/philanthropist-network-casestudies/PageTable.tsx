...
const PhilanthropistCasestudiesTable = () => {
  ...
  const fetchTableData = useCallback(
    async (sort: SortType, q: string) => {
      try {
        await dataTableApi
          .getPhilanthropistCasestudiesTable({
  ...
  const deleteCategoryData = async (id: any) => {
    ...
    try {
      const response = await PhilanthropistCaseStudiesApi.delete(
        id,
        reqAuthHeader()
      );
        ...
        >
          ...
          <Tooltip title="Edit">
            <IconButton
              size="small"
              component={Link}
              href={`/admin/philanthropist-network/casestudies/edit/` + row._id}
            >
          ...
          action={
            <div>
              <Button
                ...
                variant="contained"
                component={Link}
                href={`/admin/philanthropist-network/casestudies/add`}
              >
                Add Case studies
              </Button>
              &nbsp;
...
export default PhilanthropistCasestudiesTable;
