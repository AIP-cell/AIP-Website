...
export const AddProgramsLaunchPage = ({
  popperPlacement,
}: {
  ...
  return (
    <>
      <Breadcrumbs sx={{ mb: 4 }}>
        <Link href={`/admin/programs-projects`}>
          <Typography>Programs & Projects Media</Typography>
        </Link>
            ...
            <Grid container spacing={6}>
              {/* <Grid item xs={12}>
                <LaunchFormRepeater
                  ...
                  time={(index) => register(`launchDetails.${index}.time`)}
                  location={(index) => register(`launchDetails.${index}.location`)}
                />
              </Grid> */}
            </Grid>
          </CardContent>
...
export default AddProgramsLaunchPage;
