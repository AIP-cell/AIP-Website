...
const FoundationFactsTable = () => {
  ...
  //     try {
  //       const response = await axios.get(`/api/admin/demoPage/table-data`, {
  //         params: {
  //           sort,
  //           q,
  ...
  const deleteCategoryData = async (id: any) => {
    ...
    // try {
    //   const response = await HomePageApi.delete(id);
  ...
  const columns: GridColDef<any>[] = [
    ...
    },
    {
      flex: 0.275,
      minWidth: 290,
      field: "footprintsCount",
      headerName: "Footprints Count",
        ...
        >
          ...
          <Tooltip title="Edit">
            <IconButton
              size="small"
              component={Link}
              href={`/admin/banners/edit/` + row._id}
            >
  ...
  return (
    <>
      <Breadcrumbs aria-label="breadcrumb" sx={{ mb: 4 }}>
        <Link href={`/admin/about-us/foundation-facts`}>
          ...
          action={
            <div>
              <Button
                ...
                variant="contained"
                component={Link}
                href={`/admin/aip-impact/foundation-facts/add`}
              >
                Add
              </Button>
              &nbsp;
...
export default FoundationFactsTable;
