...
export const EditCollaborationsTestimonialPage = (
  { values }: any,
  {
    popperPlacement,
  }: {
  ...
  const onSubmit = async (values: TyearSchema) => {
    try {
      const response = await CollaborationTestimonialApi.updateCasestudies(
        id,
        values
      );
...
export default EditCollaborationsTestimonialPage;
