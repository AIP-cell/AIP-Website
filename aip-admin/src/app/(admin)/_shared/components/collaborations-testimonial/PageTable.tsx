...
const CollaborationTestimonialTable = () => {
  ...
  const fetchTableData = useCallback(
    async (sort: SortType, q: string) => {
      try {
        await dataTableApi
          .getCollaborationCityTestimonialTable({
  ...
  const deleteCategoryData = async (id: any) => {
    ...
    try {
      const response = await CollaborationTestimonialApi.delete(
        id,
        reqAuthHeader()
      );
      ...
      if (response.data.success) {
        ...
        router.push(`/admin/collaborations/testimonial/` + city + "/" + id);
        fetchTableData("asc", query);
      } else {
        ...
        >
          ...
          <Tooltip title="Edit">
            <IconButton
              size="small"
              component={Link}
              href={`/admin/collaborations/testimonial/edit/` + row._id}
            >
  ...
  return (
    <>
      ...
      <Card>
        <CardHeader
          title="Collaboration Gallery Of Voices"
          action={
            <div>
              <Button
                size="medium"
                variant="contained"
                component={Link}
                href={`/admin/collaborations/testimonial/add/` + id}
              >
...
export default CollaborationTestimonialTable;
