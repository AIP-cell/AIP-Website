...
const SelectedWorkTable = () => {
  ...
  const deleteCategoryData = async (id: any) => {
    ...
    try {
      const response = await AipTeamSelectedWorkApi.delete(id, reqAuthHeader());
        ...
        >
          ...
          <Tooltip title="Edit">
            <IconButton
              size="small"
              component={Link}
              href={`/admin/team-aip/selected-works/edit/` + row._id}
            >
          ...
          action={
            <div>
              <Button
                ...
                variant="contained"
                component={Link}
                href={`/admin/team-aip/selected-works/add`}
              >
                Add Selected Work
              </Button>
              &nbsp;
...
export default SelectedWorkTable;
