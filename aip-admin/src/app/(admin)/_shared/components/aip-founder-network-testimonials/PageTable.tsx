...
const AipFounderNetworkTestimonialTable = () => {
  ...
  const fetchTableData = useCallback(
    async (sort: SortType, q: string) => {
      try {
        await dataTableApi
          .getFoundersNetworkTestimonialTable({
  ...
  const deleteCategoryData = async (id: any) => {
    ...
    try {
      const response = await FoundersNetworkTestimonialsApi.delete(
        id,
        reqAuthHeader()
      );
        ...
        >
          ...
          <Tooltip title="Edit">
            <IconButton
              size="small"
              component={Link}
              href={`/admin/aip-founders-network/testimonial/edit/` + row._id}
            >
  ...
  return (
    <>
      ...
      <Card>
        <CardHeader
          title="AIP Founder Network Testimonial"
          action={
            <div>
              <Button
                size="medium"
                variant="contained"
                component={Link}
                href={`/admin/aip-founders-network/testimonial/add`}
              >
                Add Testimonial
              </Button>
              &nbsp;
...
export default AipFounderNetworkTestimonialTable;
