...
export const AboutUsAipImpactSection = () => {
  ...
  return (
    <>
      ...
      <Card>
        ...
        <img
          src="/images/sections/about-us-aip-impact/section1.png"
          alt="Section 1"
          style={{
            width: "100%",
            height: "500px",
        ...
        <img
          src="/images/sections/about-us-aip-impact/section2.png"
          alt="Section 1"
          style={{
            width: "100%",
            height: "500px",
        ...
        <img
          src="/images/sections/about-us-aip-impact/section3.png"
          alt="Section 1"
          style={{
            width: "100%",
            height: "500px",
        ...
        <img
          src="/images/sections/about-us-aip-impact/section4.png"
          alt="Section 1"
          style={{
            width: "100%",
            height: "500px",
...
export default AboutUsAipImpactSection;
