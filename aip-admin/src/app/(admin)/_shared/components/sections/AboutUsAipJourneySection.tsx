...
export const AboutUsAipJourneySection = () => {
  ...
  return (
    <>
      ...
      <Card>
        ...
        <img
          src="/images/sections/about-us-aip-journey/section1.png"
          alt="Section 1"
          style={{
            width: "100%",
            height: "500px",
        ...
        <img
          src="/images/sections/about-us-aip-journey/section2.png"
          alt="Section 1"
          style={{
            width: "100%",
            height: "500px",
        ...
        <img
          src="/images/sections/about-us-aip-journey/section3.png"
          alt="Section 1"
          style={{
            width: "100%",
            height: "500px",
...
export default AboutUsAipJourneySection;
