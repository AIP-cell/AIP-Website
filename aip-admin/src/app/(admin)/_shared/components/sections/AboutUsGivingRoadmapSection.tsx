...
export const AboutUsGivingRoadmapSection = () => {
  ...
  return (
    <>
      ...
      {/* Form Card */}
      <Card>
        <CardHeader title="Giving Roadmap Sections" />
        <Divider sx={{ m: "0 !important" }} />
        <img
          src="/images/sections/about-us-giving-roadmap/section1.png"
          alt="Section 1"
          style={{
            width: "100%",
            height: "500px",
        ...
        <img
          src="/images/sections/about-us-giving-roadmap/section2.png"
          alt="Section 1"
          style={{
            width: "100%",
            height: "500px",
        ...
        <img
          src="/images/sections/about-us-giving-roadmap/section3.png"
          alt="Section 1"
          style={{
            width: "100%",
            height: "500px",
...
export default AboutUsGivingRoadmapSection;
